    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="overflow-x-auto bg-white rounded-3xl shadow-xl border border-slate-200">
        <table className="w-full text-left border-collapse">
          <thead>
            <tr>
              <th className="p-6 border-b border-r bg-slate-50 w-[15%]">
                <span className="text-lg font-bold text-slate-700">Features</span>
              </th>
              {compareColleges.map((c: any) => (
                <th key={c.id} className="p-6 border-b border-slate-200 text-center align-top w-[17%]">
                  <img src={c.image_url} alt={c.name} className="w-full h-32 object-cover rounded-xl mb-4 shadow-sm" />
                  <h3 className="text-xl font-bold text-slate-900">{c.name}</h3>
                </th>
              ))}
              {Array(5 - compareColleges.length).fill(0).map((_, i) => (
                <th key={`empty-${i}`} className="p-6 border-b border-slate-200 bg-slate-50 w-[17%]"></th>
              ))}
            </tr>
          </thead>
          <tbody>
            <tr>
              ...
              {Array(5 - compareColleges.length).fill(0).map((_, i) => <td key={`emp1-${i}`} className="p-6 border-b bg-slate-50"></td>)}
            </tr>
            <tr>
              ...
              {Array(5 - compareColleges.length).fill(0).map((_, i) => <td key={`emp2-${i}`} className="p-6 border-b bg-slate-50"></td>)}
            </tr>
            <tr>
              ...
              {Array(5 - compareColleges.length).fill(0).map((_, i) => <td key={`emp3-${i}`} className="p-6 border-b bg-slate-50"></td>)}
            </tr>
            <tr>
              ...
              {Array(5 - compareColleges.length).fill(0).map((_, i) => <td key={`emp4-${i}`} className="p-6 border-b bg-slate-50"></td>)}
            </tr>
            <tr>
              ...
              {Array(5 - compareColleges.length).fill(0).map((_, i) => <td key={`emp5-${i}`} className="p-6 border-b bg-slate-50"></td>)}
            </tr>
            <tr>
              ...
              {Array(5 - compareColleges.length).fill(0).map((_, i) => <td key={`emp6-${i}`} className="p-6 bg-slate-50"></td>)}
            </tr>
          </tbody>
        </table>
      </div>
